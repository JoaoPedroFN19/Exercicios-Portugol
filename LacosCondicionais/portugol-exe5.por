// João Pedro FN
// exercicio 5 - Laços Condicionais
...
medido e emita a notificação adequada aos diferentes grupos de empresas.
   */
    ...
    se (indice > 0.2 e indice < 0.4 ) {
    		escreva("Empresas do grupo 1 devem suspender as atividades! ")
    }
    senao se (indice > 0.3 e indice < 0.5) {
    		escreva("\nEmpresas do grupo 2 e 3 devem suspender as atividades! ")
    }
    senao se (indice >= 0.5) {
    		escreva("\nTodas as empresas devem paralisar as atividades! ")
    }
    senao {
